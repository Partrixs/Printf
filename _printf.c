 ...
 * @format: The format.
 * Return: Printed characters only.
 */
...
/**
 * print_buffer - Prints any content of the buffer if at all found.
 * @buffer: Array of the characters
 * @buff_ind: Index to which it adds the char, stand for length only.
 */
